...
"""PDFdump.py - A utility to dump PDF structure and raw bytes for analysis. Only to check the PDF structure of documents, not to extract fields. For debunging purposes only."""
